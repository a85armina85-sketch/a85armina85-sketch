...
- Essential modules: `datetime`, `collections`, `itertools`, `operator`, `os`
    ...
    <tr>
      <td width="42%" valign="top">
        <img src="django.png" alt="Django Framework Certificate - Darsman" width="100%" style="border-radius: 10px;"/>
        <p align="center">
...
- Custom Model Validators & query optimization
</details>
...
- Context injection (`get_context_data`), dynamic filtering (`get_queryset`), Pagination
- Advanced URL routing: Regex (`re_path`), Query Strings, `reverse()`, `urlencode()`
- HTTP Redirects (`HttpResponseRedirect`, `HttpResponsePermanentRedirect`, `redirect`)
</details>
...
- Email sending (`send_mail`, `EmailMultiAlternatives`, Gmail SMTP setup)
- Cookie & Session management (File-based & Cookie-based sessions)
- Asynchronous communication: jQuery AJAX integration with `JsonResponse`
</details>
...
- RESTful API design, `@api_view`, FBVs and CBVs for APIs
- Serializers & ModelSerializers, Validation
...
- `passenger_wsgi.py` setup, static/media collection, Production Database migration
</details>
      </td>
    </tr>
  </table>
